...
double updatedTotalAmount=0;
 ...
 updatedTotalAmount=widget.invoice.invoiceTotal?? totals.total;
  ...
  double get totalAmount => 
      context.read<ItemsCubit>().state.totalAmount;
    ...
    return SingleChildScrollView(
      child: Padding(
        ...
        child: Column(
         ...
         InvoiceHeaderRow(
  issued: DateFormat("d MMM yyyy").format(widget.invoice.issuedDate),
  due: "-",
        ...
        return Theme(
          data: ThemeData.light().copyWith(
            colorScheme: ColorScheme.light(
              primary: AppColors.primary, // Primary color for the date picker
...
; 
            ...
            FilledTextButton(
              ...
              text: "Delete Invoice",
              onPressed: (){
                deleteInvoiceByNumber(invoiceNumber: widget.invoice.invoiceNumber);
                context.pop();
                context.pop();
              }  
            ),
